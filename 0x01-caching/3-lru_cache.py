...
"""
Task:
    eate a class LRUCache that inherits from BaseCaching and is
     a caching system:
...
class LRUCache(BaseCaching):
    ...
    def put(self, key, item):
        ...
        if key is not None and item is not None:
            ...
            if len(self.self.cache_data) > BaseCaching.MAX_ITEMS:
                last_key, last_value = self.self.cache_data.popitem()
